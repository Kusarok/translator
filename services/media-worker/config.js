...
export const config = {
  ...
  tempDir: path.join(rootDir, "data", "temp"),
  databaseDir: path.join(rootDir, "data", "database"),
  tracksDir: path.join(rootDir, "data", "tracks"),
  lyricsDir: path.join(rootDir, "data", "lyrics"),
  translationsDir: path.join(rootDir, "data", "translations"),
  artworkDir: path.join(rootDir, "data", "artwork"),
